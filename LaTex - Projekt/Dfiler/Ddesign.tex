...
\subsection{Kode udsnit \& diagrammer}
...
\begin{figure}[H]
	...
	\label{kode2}
\end{figure}
Algoritmen til detektering af puls foregår også efter dette princip. Her skal man blot kende perioden eller frekvensen på samplingen og medsende denne som parameter.
