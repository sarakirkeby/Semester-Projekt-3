...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
 ...
 \\   
 	2. & Tryk 'Start' &    Et tryk der kan differentiere fra det kendte kommer frem på skærmen &     &		%{\Huge \checkmark}
 \\
 	3. & Skriv resultatet ned og gentag punkt 2., 2 gange mere &    Der er tre måleafvigelser skrevet ned &     &		%{\Huge \checkmark}
 \\
 	4. & Udregn gennemsnit for afvigelse og omregn til procenter &   Afvigelses koefficient er fundet &     &		%{\Huge \checkmark}
 \\
 	5. & Indtast afvigelses koeffivient i tekstboksen &    Systemet er kalibreret &     &		%{\Huge \checkmark}
 \\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
	...
	\\
	2. & Tryk på "Log ind"\--knappen & Log ind oplysninger er gyldige og stemmer overens med hinanden. Tekstfelter til log ind skjules og "Nulstil"\--knappen vises & & %{\Huge \checkmark}
	\\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    ~ &\textit{Hovedscenarie} & ~ & ~ &
    \\ \midrule
    1. & Tryk på "start"\--knappen i i blodtryksvindueet &    Graf og blodtryks værdier vises på brugergrænsefladen  &    &		%{\Huge (\checkmark)} 
 \\ \bottomrule
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    ~ &\textit{Hovedscenarie} & ~ & ~ &
    \\ \midrule
    1. & Indtast 100 for diastolisk øvre grænse &    Der står 100 i pågældende tekst felt &     &		%{\Huge \checkmark}
   	\\
   	2. & Indtast 80 for diastolisk nedre grænse &    Der står 100 i pågældende tekst felt &     &		%{\Huge \checkmark}
   	\\ 
   	3. & Indtast 100 for systolisk øvre grænse &    Der står 120 i pågældende tekst felt &     &		%{\Huge \checkmark}
   	\\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    ~ &\textit{Hovedscenarie} & ~ & ~ &
    \\ \midrule
    1. & Tryk på "Afslut"\--knappen &   "Gemme"\--vinduet vises &     &		%{\Huge \checkmark}
   	\\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] X[j] l@{}}
	...
	1. & Brugeren skal kunne starte en ny måling indenfor XX sekunder efter opstart & Start programmet, hvorefter der vha. stopur måles opstartstiden & At programmet er opstartet og ny måling er igang efter XX sekunder &  & %{\Huge \checkmark}
	\\ \midrule
	...
	13. & Programmet bør kunne give alarm, hvis det systoliske blodtryk overstiger 140 mmHg eller falder under 100 mmHg & Påsæt blodtryksignal fra Physionet der overskrider valgte grænser & At en alarm med frekvens på XX begynder & & \\ \midrule
	14. & Programmet bør kunne give alarm, hvis det diastoliske blodtryk overstiger 90 mmHg eller falder under XX mmHg & Påsæt blodtryksignal fra Physionet der overskrider valgte grænser & At en alarm med frekvens på XX begynder & & \\ \midrule
	...
	3. & Brugeren skal kunne starte en måling på maksimalt 20 sekunder & Start systemet op, log ind og tryk "Start måling" & At programmet er opstartet og ny måling er startet på under 20 sekunder & &  \\ \midrule
	4. & Brugergrænseflade lever op til nedensående figur & Opstart program og log ind & At brugergrænseflade indeholder samtlige funktioner som på figuren & &  \\ \midrule
	...
	1. & Systemet bør kunne gemme data på 5 sekunder +/- 10 sekunder & Tryk på "Gem og afslut"\--knap og tag tid med stopur & At data er inden for 5 sekunder & & \\ \midrule
