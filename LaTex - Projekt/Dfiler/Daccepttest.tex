...
\\
 	7. & Tryk på "Kalibrer"\-knappen &    Systemet er kalibreret &  Systemet viser 100 m   &		{\Huge (\checkmark)}
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
	...
	&\textit{Hovedscenarie} & & & 
	\\ \midrule
	1. & Tryk på "Nulpunksjuster"\--knap & Panel vises med intruktioner om nulpunktsjustering & Panel vises med instruktioner & {\Huge \checkmark}
	\\
	2. & Tryk på "indlæs tryk"\--knap & Et tryk vises tekstboksen & Tryk vises & {\Huge \checkmark}
	\\
	3. & Tryk på "Godkend"\--knap & Panelet lukkes & Panelet lukkes & {\Huge \checkmark}
	\\
	4. & Indtast personale-ID i brugenavnsfeltet; "1234" og indtast personlig kode i kodeordsfeltet; "fido" & Loginoplysninger bliver udfyldt & De rigtige oplysninger vises & {\Huge \checkmark}
	\\
	5. & Tryk på "Log ind"\--knappen & Log ind oplysninger er gyldige og stemmer overens med hinanden. "Blodtryks"\-vinduet vises  & Login vinduet lukkes og blodtryk vinduet vises & {\Huge \checkmark}
	\\
	\\ \midrule
	& \textit{Undtagelser} & & &\\ \midrule
	5.a & Indtast personale-ID i brugenavnsfeltet; "fido" og indtast personlig kode i kodeordsfeltet; "1234" & Nye log ind oplysninger indtastes og besked om at de ikke findes vises & Besked vises & {\Huge \checkmark}
	\\ \bottomrule
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    ~ &\textit{Hovedscenarie} & ~ & ~ &
    \\ \midrule
    1. & Påsæt signal fra fysionet &    Signalet fungerer  & signalet fungerer  &		{\Huge \checkmark} \\
    2. & Tryk på "start"\--knappen i i blodtryksvinduet &    Graf og blodtryks værdier vises på brugergrænsefladen  &  Graf vises og værdierne  &		{\Huge \checkmark} 
 \\ \bottomrule
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
    ...
    1. & Indstil cursor til 100 for diastolisk øvre grænse &    Der står 100 i pågældende tekst felt & Der står 100 i pågældende tekst felt    &		{\Huge \checkmark}
   	...
   	\\
   	4. & Indstil cursor til 80 for systolisk øvre grænse &    Der står 80 i pågældende tekst felt &   Der står 80 i pågældende tekst felt  &		{\Huge \checkmark}
 	\\ 
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] X[j] l@{}}
	...
	\\ \midrule
	3. & Systemet skal kunne forstærke signalet med det indbyggede analoge antialiaserings filter med en båndbredde på 50 Hz & Start systemet & At signalet er forstærket & Egentlige test ligger i integrationstest & {\Huge (\checkmark)}\\ \midrule
	6. & Programmet skal kunne vise blodtrykssignalet kontiunert & Tryk på "Start måling"\--knap & At blodtrykssignalet er vist kontinuert på brugergrænsefladen &  & {\Huge \checkmark}\\ \midrule
	7. & Programmet skal programmeres i C\# & Start programmet & At koden er i C\# & & {\Huge \checkmark} \\ \midrule

	12. & Programmet bør kunne måle og afbillede puls & Tryk på "Start måling" & At pulsen er afbilledet på brugergrænseflade & & {\Huge \checkmark} \\ \midrule
	
	& \textit{Usability} &  &  & & \\ \midrule
	1. & Blodtrykstallene der udskrives på brugergrænseflade er røde & Tryk "Start måling"\--knap & At Blodtrykstallene er røde & & {\Huge \checkmark} \\ \midrule
	2. & Pulsmålingen skal udskrives på brugergrænsefladen med grønne tal & Tryk "Start måling"\--knap & At pulsen vises med grønne tal & &  {\Huge \checkmark} \\ \midrule
	3. & Brugergrænseflade lever op til nedensående figur & Opstart program og log ind & At brugergrænseflade indeholder samtlige funktioner som på figuren & & {\Huge \checkmark} \\ \midrule
	...
	1. & Softwaren er opbygget af trelagsmodellen & Kig i koden efter data-lag, logik-lag og GUI-lag & At koden indeholder et data-lag, et logik-lag og et GUI-lag &  & {\Huge \checkmark}\\ \bottomrule
