...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] X[j] l@{}}
	...
	2. & Systemet skal kunne forstærke signalet med det indbyggede analoge filter med en båndbredde på 50 Hz & Start systemet & At signalet er forstærket & Egentlige test ligger i integrationstest, se afsnit \ref{ModulHard}  & {\Huge (\checkmark)}\\ \midrule
