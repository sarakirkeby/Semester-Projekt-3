...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
 ...
 \\
 	4. & Udregn gennemsnit for afvigelse og omregn til procenter &   Afvigelseskoefficient er fundet &     &		%{\Huge \checkmark}
 \\
...
\begin{longtabu} to \linewidth{@{} c X[j] X[j] X[j] l@{}}
	...
	\\
	2.a. & Indtast CPR-nummeret "1111111118" & Beskeden "CPR ikke gyldigt." vises\ & 		& %{\Huge \checkmark}	
 \\ \bottomrule
