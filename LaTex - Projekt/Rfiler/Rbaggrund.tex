...
\begin{figure}[H]
	...
	\caption{Opstilling af intraarteriel blodtryksmåling \site }
	\label{intramaaling}
\end{figure}

Som set på figur \ref{intramaaling}, placeres en nål inter-arterielt på en patient. Denne nål er forbundet til en trykpose, med et natriumklorid fyldt kateter, påsat transducer. Posen fungerer som en udtømningsmekanisme, som sørger for at der ikke er bobler i kateteret. Det interne tryk i posen bliver reguleret, til at ligge over patientens systoliske blodtryk. \\
Når trykket i posen bliver reguleret, kan dette observeres på den tilkoblede monitor. Når trykreguleringen stoppes, fortsætter posen, med at dryppe natriumklorid i kateteret, da det stopper blod fra, at fylde kateteret. Trykket fra patientes arterie kan nu læses, da trykket i kateteret stemmer oversens med det tryk, der kan findes i arterien. 

\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Figurer/Fysio/trykmaaling}
	\caption{Grafisk afbildning af blodtryk \site }
	\label{grafiskmaaling}
\end{figure}

Et eksempel på en måling kan ses på figur \ref{grafiskmaaling}. Her ses det, at målingen består af en masse bølger. Disse bølger repræsenterer det samlede blodtryk og hver bølge, repræsenterer et pulslag. Toppen af bølgen repræsenterer det systoliske blodtryk, og minimummet repræsenterer det diastoliske.  

\textbf{Mads Sene Aften Tanker}
Der føres der et væskefyldt kateter ind i personens arterie. Trykposen på er fyldt med natriumklorid og fungerer som en del af en flushmekanismen, der benyttes til at fjerne bobler fra det væskefyldte kateter. Trykket i posen pumpes op til mellem 180 til 300 mmHg, hvilket er over det systoliske blodtryk.
