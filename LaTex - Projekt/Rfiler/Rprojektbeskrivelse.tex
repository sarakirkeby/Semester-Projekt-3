...
Helt generelt er softwaren i blodtrykssystemet bygget op omkring 3-lagsmodellen. 3-lagsmodellen er bestående af lagene præsentationslag, logiklag og datalag.
\subsection{Tråde}
